...
#### (追加) テスト機能 
現在、単語の定着度を測る際に
- 従来の4択形式ではなく、ユーザーが入力した日本語訳が概ね正しいかをChatGPTが判定する
- 忘却曲線によって算出した定着率の低い順に出題する

ような実装に取り組んでいます。選択肢に頼った曖昧な確認ではなく、しっかりとした定着度チェックを効率的に行うことができます。
...
<br>
<br>
単語リスト画面にて excerbate の意味として登録されている「悪化させる」と完全に同じでなくとも、概ね同じ意味を持つ「酷くさせる」を回答できれば正解になります。
...
- [x] 単語リストの表示の工夫 (e.g. エビングハウスの忘却曲線に基づく定着率の低いもの順)
